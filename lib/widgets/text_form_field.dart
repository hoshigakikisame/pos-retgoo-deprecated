...
/// {@tool sample}
///
/// Creates a [TextFormFieldX] with an [InputDecoration] and validator function.
///
/// ```dart
/// TextFormField(
...
class TextFormFieldX extends FormField<String> {
    ...
    this.onChanged,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            final TextFormFieldState state = field;
...
class TextFormFieldState extends FormFieldState<String> {
  ...
  @override
  TextFormFieldX get widget => super.widget;
  ...
  @override
  void didUpdateWidget(TextFormFieldX oldWidget) {
